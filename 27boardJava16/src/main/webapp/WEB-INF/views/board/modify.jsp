				...
				<div class="card-body">
					<form:form action="${root }board/read" modelAttribute="modifyContentDTO" method="get">
						...
						<div class="form-group">
							<form:label path="cotent_writer_name">작성자</form:label>
							<form:input type="text" path="cotent_writer_name" class="form-control" readonly="true"/>
						</div>
						<div class="form-group">
							<form:label path="cotent_date">작성날짜</form:label>
							<form:input type="text" path="cotent_date" class="form-control" readonly="true"/>
						</div>
						<div class="form-group">
