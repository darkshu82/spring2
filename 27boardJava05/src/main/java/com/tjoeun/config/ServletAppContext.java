...
public class ServletAppContext implements WebMvcConfigurer{
	...
	public MapperFactoryBean<DeveloperMapper> getDeveloperMapper(SqlSessionFactory factory) throws Exception{
		MapperFactoryBean<DeveloperMapper> factoryBean = new MapperFactoryBean<>(DeveloperMapper.class);
		factoryBean.setSqlSessionFactory(factory);
		return factoryBean;
	}
	...
	public void addInterceptors(InterceptorRegistry registry) {
		...
		DeveloperInterceptor developerInterceptor = new DeveloperInterceptor(developerService);
